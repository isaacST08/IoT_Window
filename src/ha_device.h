...
#define HA_DEVICE_MQTT_DISCOVERY_MSG                                           \
  "{"                                                                          \
  "  \"dev\": {"                                    /* device */               \
  "    \"ids\": \"" HA_DEVICE_ID "\","              /* identifiers */          \
  "    \"name\": \"" HA_DEVICE_ID "\","             /* name */                 \
  "    \"mf\": \"" HA_DEVICE_MANUFACTURER "\","     /* manufacturer */         \
  "    \"mdl\": \"" HA_DEVICE_MODEL "\","           /* model */                \
  "    \"sw\": \"" HA_DEVICE_SOFTWARE_VERSION "\"," /* sw_version */           \
  "    \"sn\": \"" HA_DEVICE_SERIAL_NUMBER "\","    /* serial_number */        \
  "    \"hw\": \"" HA_DEVICE_HARDWARE_VERSION "\""  /* hw_version */           \
  "  },"                                                                       \
  "  \"o\": {" /* origin */                                                    \
  "    \"name\": \"foobar\","                                                  \
  "    \"sw\": \"" HA_DEVICE_SOFTWARE_VERSION "\"" /* sw_version */            \
  ...
  "    \"" HA_DEVICE_ID "-Main_Window\": {"                                    \
  "      \"name\": \"Main Window\","                                           \
  "      \"unique_id\": \"" HA_DEVICE_ID "-Main_Window\","                     \
  "      \"optimistic\": \"false\","                                           \
  "      \"availability\": {"                                                  \
  ...
  "    \"" HA_DEVICE_ID "-Main_Window_Speed\": {"                              \
  "      \"name\": \"Main Window Speed\","                                     \
  "      \"unique_id\": \"" HA_DEVICE_ID "-Main_Window_Speed\","               \
  "      \"optimistic\": \"false\","                                           \
  "      \"availability\": {"                                                  \
  "        \"payload_available\": \"online\","                                 \
  "        \"payload_not_available\": \"offline\","                            \
  ...
  "    \"" HA_DEVICE_ID "-Main_Window_Position_Steps\": {"                     \
  "      \"name\": \"Main Window Position Steps\","                            \
  "      \"unique_id\": \"" HA_DEVICE_ID "-Main_Window_Position_Steps\","      \
  "      \"optimistic\": \"false\","                                           \
  "      \"availability\": {"                                                  \
  "        \"payload_available\": \"online\","                                 \
  "        \"payload_not_available\": \"offline\","                            \
  ...
  "    \"" HA_DEVICE_ID "-Main_Window_Position_Millimeters\": {"               \
  ...
  "    \"" HA_DEVICE_ID "-Quiet_Mode_Switch\": {"                              \
  "      \"name\": \"Quiet Mode Switch\","                                     \
  "      \"unique_id\": \"" HA_DEVICE_ID "-Quiet_Mode_Switch\","               \
  "      \"optimistic\": \"false\","                                           \
  "      \"availability\": {"                                                  \
  "        \"payload_available\": \"online\","                                 \
  "        \"payload_not_available\": \"offline\","                            \
